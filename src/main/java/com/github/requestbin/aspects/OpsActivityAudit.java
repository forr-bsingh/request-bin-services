package com.github.requestbin.aspects;

import com.github.requestbin.data.Ops;
import com.github.requestbin.repos.AuditRepo;
...
public class OpsActivityAudit {
    ...
    @Around(value = "execution(* com.github.requestbin.services.impl.OpsServiceImpl.postOps(..))")
    ...
    @Around(value = "execution(* com.github.requestbin.services.impl.OpsServiceImpl.getOps(..))")
    ...
    @Around(value = "execution(* com.github.requestbin.services.impl.OpsServiceImpl.listOps(..))")
    ...
    @Around(value = "execution(* com.github.requestbin.services.impl.OpsServiceImpl.deleteOps(..))")
    ...
    @Around(value = "execution(* com.github.requestbin.services.impl.OpsServiceImpl.patchOps(..))")
    ...
    @Around(value = "execution(* com.github.requestbin.services.impl.OpsServiceImpl.putOps(..))")
